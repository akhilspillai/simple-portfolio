...
const ABOUT =
  ...
  "scalable solutions, built mobile as well as web applications and executed innovative ideas. I have build up deep understanding on application " +
  ...
  "I have always been a quick learner, jumping right into any technology stacks as and when required while delivering high " +
  "quality software.";
